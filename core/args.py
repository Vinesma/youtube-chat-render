...
class Args:
    ...
    def __init__(
        ...
        output_video_path = os.path.join(_main_dir, 'output.mp4'),
        chat_font_size = 14,
    ...
    def load_args(self):
        ...
        parser.add_argument("-oc", "--output-chat", help="Where to output the generated chat video. Default = '.'")
        parser.add_argument("-ov", "--output-video", help="Where to output the video with overlaid chat. Default = '.'")
